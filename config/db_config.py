...
# mysql config
RELATION_DB_PWD = os.getenv("RELATION_DB_PWD", "media_crawler")
RELATION_DB_USER = os.getenv("RELATION_DB_USER", "media_crawler")
RELATION_DB_HOST = os.getenv("RELATION_DB_HOST", "172.19.0.2")
...
# redis config
REDIS_DB_HOST = "172.19.0.3"  # your redis host
REDIS_DB_PWD = os.getenv("REDIS_DB_PWD", "password")  # your redis password
